...
//create img
  ...
  // Vaihtoehtoisia tapoja lisätä attribuutit
  i.alt = pic.title;
...
// loopissa voidaan lisätä jokaiselle erikseen
  f.addEventListener('click', function(event) {
    alert(`Klikkasit kuvaa, otsikkolla ${pic.title}`)
...
footer.addEventListener('mouseover', function(event) {
  alert(`Veit hiiren footerin päällle`)
})
